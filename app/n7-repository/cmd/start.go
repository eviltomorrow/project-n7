...
import (
	...
	"github.com/eviltomorrow/project-n7/app/n7-repository/conf"
	"github.com/eviltomorrow/project-n7/app/n7-repository/server"
...
func runDB() error {
	...
	self.RegisterClearFuncs(mysql.Close)
